...
const Calculator = () => {
  ...
  // Função para simular o cálculo
  const calcular = () => {
    // Simulação do cálculo (exemplo simplificado)
    const reducaoCO2 = placas * area * exposicao * 0.8; // Fórmula fictícia
    const novoHistorico = {
    ...
    // Atualiza o gráfico (simula dados ao longo de 6 meses)
